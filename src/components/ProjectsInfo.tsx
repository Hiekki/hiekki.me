...
import { BsArrowUpRight, BsGithub, BsDiscord } from 'react-icons/bs';
                                    ...
                                    {project.invite !== '#' && (
                                        <Link href={project.invite}>
                                            <TooltipProvider delayDuration={500}>
                                                <Tooltip>
                                                    <TooltipTrigger className='group flex h-[70px] w-[70px] items-center justify-center rounded-full bg-black/5 dark:bg-white/5'>
                                                        <BsDiscord className='text-3xl text-black group-hover:text-purple-500 dark:text-white' />
                                                    </TooltipTrigger>
                                                    <TooltipContent>
                                                        <p>{`Invite ${project.title}`}</p>
                                                    </TooltipContent>
                                                </Tooltip>
                                            </TooltipProvider>
                                        </Link>
                    ...
                    <div className='container mx-auto'>
                        <div className='flex flex-col items-center gap-4 pt-12'>
                            <p className='text-sm text-black/60 dark:text-white/60'>
                                Questions about a project? Reach out to me on{' '}
                                <a
                                    className='text-purple-500 hover:text-purple-600 hover:dark:text-purple-400'
                                    href='https://discord.gg/elenora'
                                >
                                    Discord
                                </a>
                                .
